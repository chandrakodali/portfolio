...
Complete Infrastructure-as-Code solution deploying managed Kubernetes clusters with comprehensive IAM, networking, and storage configuration.

**Tech Stack:** Terraform · AWS EKS · VPC · IAM · EFS · CloudWatch

**Highlights:**
- 🏗️ Multi-AZ VPC with public/private subnets
- 🔐 RBAC with Admin/Developer/ReadOnly personas
- 💾 EFS CSI driver with persistent volume provisioning
- 🔒 OIDC provider for service account authentication
- 📊 Full CloudWatch logging integration

---

### 💰 [AWS Cost Anomaly Detector](https://github.com/chandrakodali/aws-cost-anomaly-detector)
> **Serverless solution for real-time AWS spend monitoring**

Automated cost monitoring with Slack alerts for anomaly detection. Runs entirely in the AWS Free Tier with zero operational overhead.

**Tech Stack:** Python · AWS Lambda · Cost Explorer · EventBridge · CloudFormation

**Highlights:**
- 📈 Daily cost analysis with threshold-based alerts
- 💬 Instant Slack notifications for cost spikes
- ⚙️ One-click CloudFormation deployment
- 🔄 EventBridge scheduler for automated runs
- 💸 100% Free Tier compatible

---

### 🧪 [Selenium Test Automation Framework](https://github.com/chandrakodali/Sel_Framework) ⭐
> **Enterprise-grade Java testing framework with CI/CD integration**

Scalable Page Object Model framework with Extent Reports, Excel data-driven testing, and GitHub Actions CI.

**Tech Stack:** Java · Selenium · TestNG · Gradle · Docker · Extent Reports

**Highlights:**
- 📋 POM architecture with reusable utilities
- 📊 Rich HTML test reports with screenshots
- 🔀 Selenium Grid support for parallel execution
